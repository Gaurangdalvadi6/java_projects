									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="name" class="form-control1"
												id="focusedinput" value="<%=c.getName()%>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input name="contact" type="text" class="form-control1"
												id="focusedinput" value="<%=c.getContact()%>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="address" class="form-control1"
												id="inputPassword" value="<%=c.getAddress()%>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="email" name="email" class="form-control1"
												id="inputPassword" value="<%=c.getEmail()%>">
										</div>
									</div>
									<div class="form-group">
									<div class="col-sm-3"></div>
										<div class="col-sm-5">
											<input type="submit" class="form-control1" id="inputPassword"
												value="admin customer update" name="action">
										</div>
									<div class="col-sm-3"></div>
									</div>
								</form>
