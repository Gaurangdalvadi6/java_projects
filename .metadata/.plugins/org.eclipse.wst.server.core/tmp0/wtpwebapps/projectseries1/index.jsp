			...
			<div class="row footer-top">
				<div class="col-lg-4 footer-grid_section_w3layouts">
					...
					<ul class="w3layouts_social_list list-unstyled">
						<li><a href="https://www.facebook.com/gaurang.dalvadisathvara.7" class="w3pvt_facebook"> <span
								class="fa fa-facebook-f"></span>
						</a></li>
						<li class="mx-2"><a href="https://twitter.com/dalvadigaurang" class="w3pvt_twitter"> <span
